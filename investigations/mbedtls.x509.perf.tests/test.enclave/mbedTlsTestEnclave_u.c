...
static const oe_ecall_info_t __mbedTlsTestEnclave_ecall_info_table[] = 
{
    { "ECALL_mbedTlsTestMethod" },
    { "ECALL_stopTesting" },
...
oe_result_t mbedTlsTestEnclave_ECALL_mbedTlsTestMethod(
    ...
    int* _retval)
{
    ...
    /* Marshalling struct. */
    ECALL_mbedTlsTestMethod_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(ECALL_mbedTlsTestMethod_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ECALL_mbedTlsTestMethod_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (ECALL_mbedTlsTestMethod_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __mbedTlsTestEnclave_ecall_info_table[mbedTlsTestEnclave_fcn_id_ECALL_mbedTlsTestMethod].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (ECALL_mbedTlsTestMethod_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(mbedTlsTestEnclave_ECALL_mbedTlsTestMethod, ECALL_mbedTlsTestMethod);

oe_result_t mbedTlsTestEnclave_ECALL_stopTesting(
    oe_enclave_t* enclave,
    int* _retval)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ECALL_stopTesting_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ECALL_stopTesting_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ECALL_stopTesting_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ECALL_stopTesting_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __mbedTlsTestEnclave_ecall_info_table[mbedTlsTestEnclave_fcn_id_ECALL_stopTesting].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ECALL_stopTesting_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(mbedTlsTestEnclave_ECALL_stopTesting, ECALL_stopTesting);

oe_result_t mbedTlsTestEnclave_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __mbedTlsTestEnclave_ecall_info_table[mbedTlsTestEnclave_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(mbedTlsTestEnclave_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t mbedTlsTestEnclave_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __mbedTlsTestEnclave_ecall_info_table[mbedTlsTestEnclave_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(mbedTlsTestEnclave_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t mbedTlsTestEnclave_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __mbedTlsTestEnclave_ecall_info_table[mbedTlsTestEnclave_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(mbedTlsTestEnclave_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t mbedTlsTestEnclave_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __mbedTlsTestEnclave_ecall_info_table[mbedTlsTestEnclave_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(mbedTlsTestEnclave_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t mbedTlsTestEnclave_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __mbedTlsTestEnclave_ecall_info_table[mbedTlsTestEnclave_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(mbedTlsTestEnclave_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t __mbedTlsTestEnclave_ocall_function_table[] = {
...
oe_result_t oe_create_mbedTlsTestEnclave_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               __mbedTlsTestEnclave_ocall_function_table,
               81,
               __mbedTlsTestEnclave_ecall_info_table,
                7,
               enclave);
}
