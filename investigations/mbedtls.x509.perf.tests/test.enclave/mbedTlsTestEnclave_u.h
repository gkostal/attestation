 ...
 */
#ifndef EDGER8R_MBEDTLSTESTENCLAVE_U_H
#define EDGER8R_MBEDTLSTESTENCLAVE_U_H

#include <openenclave/host.h>

#include "mbedTlsTestEnclave_args.h"
...
/**** ECALL prototypes. ****/
oe_result_t ECALL_mbedTlsTestMethod(
    oe_enclave_t* enclave,
    int* _retval);

oe_result_t ECALL_stopTesting(
    oe_enclave_t* enclave,
    int* _retval);
...
#endif // EDGER8R_MBEDTLSTESTENCLAVE_U_H
